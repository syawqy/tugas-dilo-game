...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        if(isUpdate)
        {
            ...
            RaycastHit2D[] circleCastHit2DArray = Physics2D
                .CircleCastAll(ballRigidbody.position, ballCollider.radius, ballRigidbody.velocity.normalized);
    ...
    public void ToggleActive(bool stat)
    {
        ballAtCollision.SetActive(stat);
        isUpdate = stat;
    }
}
